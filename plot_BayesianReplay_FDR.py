...
# %% Load all sessions
results_dir = params['path_to_output']+"/bayesian_replay_Bonferroni"
...
plt.ylabel('N')
plt.savefig("../../output_REM/REMpost_allEventsJumpiness_Bonferroni.pdf")
...
plt.ylabel('N')
plt.savefig("../../output_REM/REMpost_replayScores_Bonferroni.pdf")
