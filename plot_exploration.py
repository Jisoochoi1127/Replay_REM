...
for condition, mouse in tqdm(list(itertools.product(condition_list,
    ...
    try:
        ...
        plt.plot(data['position'][:,0],data['position'][:,1],'C4',linewidth=.2)
        plt.plot([0,100],[0,0],'k', linewidth=.6)
        plt.plot([0,100],[15,15],'k', linewidth=.6)
        plt.plot([0,0],[0,15],'k', linewidth=.6)
        plt.plot([100,100],[0,15],'k', linewidth=.6)
